    ...
    <View>
      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.center}>
          <Text>
            Căn cứ Thông tư số 45/2013/TT-BTC của Bộ Tài Chính về “Hướng dẫn chế
            độ quản lý, sử dụng và trích khấu hao máy móc, thiết bị cố định”.
          </Text>
        </View>
        ...
        <Text style={styles.heading}>Điều 1. QUY ĐỊNH KHI THUÊ THIẾT BỊ</Text>
        <View>
          ...
          <Text>Nếu thiết bị mất, phải đền bù giá trị của sản phẩm đó.</Text>
          <Text>Hai bên giao nhận thiết bị sau khi thanh toán hóa đơn.</Text>
          <Text>
            Thiết bị thuê phải đúng loại, số lượng, đúng thời gian và địa điểm
            đã thoả thuận, đảm bảo máy móc, thiết bị còn nguyên vẹn, đạt tiêu
            chuẩn chất lượng như đã quy định tại hợp đồng này.
          </Text>
        </View>
        ...
        <Text>
          <Text style={styles.bold}>Mục đích thuê: Phục vụ để canh tác</Text>{" "}
          {contract.purpose}
        </Text>
        <Text>
          <Text style={styles.bold}>Thời hạn thuê:</Text> {contract?.rentDay}{" "}
          ngày
        </Text>
        ...
        <Text>
          <Text style={styles.bold}>Thời hạn thanh toán:</Text> Bên A thanh toán
          cho Bên B khi nhận được hoá đơn tài chính của Bên B.
        </Text>
        <Text>
          <Text style={styles.bold}>Phương thức thanh toán:</Text> Chuyển khoản
          Ngân hàng.
        </Text>
        ...
        <View>
          ...
          <Text>
            Không cho bên thứ ba thuê lại máy móc, thiết bị mà Bên B cho Bên A
            thuê trong thời hạn cho thuê, trừ khi có sự đồng ý của Bên B.
          </Text>
          <Text>
            Yêu cầu Bên B sửa chữa và bảo dưỡng định kỳ máy móc, thiết bị cho
            thuê trừ hư hỏng nhỏ.
          </Text>
        </View>
        ...
        <View>
          ...
          <Text>
            Sửa chữa những hư hỏng, khuyết tật của máy móc, thiết bị cho thuê và
            bảo dưỡng định kỳ.
          </Text>
          <Text>
            Bồi thường thiệt hại nếu giao máy móc không đúng như đã thỏa thuận.
          </Text>
        </View>

        <Text style={styles.heading}>Điều 7. HIỆU LỰC CỦA HỢP ĐỒNG</Text>
        <Text>
          Hợp đồng có hiệu lực kể từ ngày ký. Trường hợp có bất kỳ điều khoản
          nào không thể thực hiện, các điều khoản còn lại vẫn có hiệu lực.
        </Text>
